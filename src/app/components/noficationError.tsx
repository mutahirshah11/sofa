...
const NotificationMessage = ({ message, onClose }: Props) => {
  ...
  return (
    <div
      ...
      } bg-red-500 text-white py-3 px-6 rounded- shadow-lg flex items-center border-[2px] border-green-400 space-x-4 z-10`}
    >
      {/* Checkmark Icon */}
      <svg
      ...
      <div className="absolute bottom-0 left-[-16px] w-full h-[5px] bg-red-200 animate-progress-bar"></div>
    </div>
  );
};
