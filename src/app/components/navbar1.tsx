...
const Navbar1 = () => {
  return (
    <div>
      {/* Navbar */}
      <div className="flex justify-center lg:justify-end items-center gap-6 md:gap-24 lg:gap-32 xl:gap-40 w-full h-[80px] lg:h-[100px] bg-white relative">
        {/* Navigation Pages */}
              ...
              <div className="flex flex-col">
                ...
                <div className=" mt-[200px]">
                  ...
                  <div className="  flex justify-center items-center gap-3">
                    ...
                    >
                      <p className="mt-1.5 hover:bg-gray-100">View Cart</p>
                    </Link>
                    <Link
                      href={"../Checkout"}
                      className="w-[145px] h-[36px] border text-center text-[15px] border-gray-400 text-gray-400 rounded-xl  hover:bg-gray-100"
                    >
                      <p className="mt-1.5 hover:bg-gray-100">Checkout</p>
                    </Link>
                  </div>
                </div>
              </div>
