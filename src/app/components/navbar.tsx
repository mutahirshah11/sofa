...
const Navbar1 = () => {
  return (
    <>
      {/* Navbar */}
      <div className="fixed top-0 left-0 w-full z-50 flex justify-center lg:justify-end items-center gap-6 md:gap-24 lg:gap-32 xl:gap-40 h-[80px] lg:h-[100px] bg-[#FBEBB5] shadow-md">
        {/* Navigation Pages */}
