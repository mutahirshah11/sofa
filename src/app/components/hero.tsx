...
const Hero = () => {
  return (
    <div className="bg-[#FBEBB5] w-[auto] md:h-[450px] lg:h-[510px] h-[530px] xl:h-[650px] flex justify-center items-center    ">
      {/* Wrapper */}
      <div className="flex flex-col md:flex-row items-center  ">
        {/* Text */}
        <div className="w-[300px] xl:w-[400px] ml-10 md:mb-32 mt-10 md:mt-0 xl:ml-36 xl:mb-28 ">
          <h1 className="font-normal text-[#000000] text-[37px] md:text-[42px] xl:text-[55px] mb-3 xl:mb-5 xl:mt-28   ">
